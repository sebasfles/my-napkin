...
| app | 2026-09-20 | A collapsed sidebar flashes open on every reload, since its width is client state with no server-rendered hint | The flash is worth a cookie or a pre-paint script |
